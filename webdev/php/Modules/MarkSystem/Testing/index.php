...
include '../Test.php';
include '../Task.php';
include '../../../essentials/databaseEssentials.php';
connectDB();

$test = new Markmanager\Test(NULL, "The great wall", time() + 20000, 0);
$test->addTask(new Markmanager\Task(NULL, 'How old am I?', 15, 'Numerical', 5));
$test->addTask(new Markmanager\Task(NULL, 'What is my name?', 'Huhu','FreeText', 10));
